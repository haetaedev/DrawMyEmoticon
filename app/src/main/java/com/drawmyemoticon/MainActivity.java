...
public class MainActivity extends AppCompatActivity {
    private RecyclerView emoticonListView;
    ...
    private void setEmoticonListView() {
        emoticonListView = findViewById(R.id.emoticonListRecyclerView);

        // use this setting to improve performance if you know that changes
        // in content do not change the layout size of the RecyclerView
        emoticonListView.setHasFixedSize(true);

        // use a linear layout manager
        layoutManager = new LinearLayoutManager(this);
        ((LinearLayoutManager) layoutManager).setOrientation(LinearLayoutManager.HORIZONTAL);
        emoticonListView.setLayoutManager(layoutManager);
        ...
        emoticonListView.setAdapter(adapter);
    }
}